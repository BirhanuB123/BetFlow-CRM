export declare const PAYMENT_STATUSES: readonly ["PENDING", "PAID", "OVERDUE", "CANCELLED"];
export type PaymentStatus = (typeof PAYMENT_STATUSES)[number];
export declare const PAYMENT_METHODS: readonly ["BANK_TRANSFER", "CASH", "CARD", "CHEQUE"];
