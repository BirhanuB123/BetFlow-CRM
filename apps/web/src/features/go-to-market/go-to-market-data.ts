...
export const landingMetrics = [
  ...
  { label: "Automation", value: "28K", detail: "Monthly customer touches" },
  {
    ...
    value: "100%",
    detail: "Scoped by tenant and role",
  },
];
...
export const resourcePages: Record<ResourcePageKey, ResourcePage> = {
  "user-guide": {
    ...
    title: "User guide",
    description:
      "Daily operating guide for agents, sales admins, and finance users.",
    active: "User guide",
    icon: BookOpen,
    metrics: [
      {
        label: "Chapters",
        value: "8",
        detail: "CRM, inventory, payments, contracts, and reporting",
      },
      {
        label: "Primary audience",
        value: "Agents",
        detail: "Sales and customer-facing users",
      },
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Log notes and timeline activity",
  ...
  "admin-guide": {
    ...
    title: "Admin guide",
    description:
      "Tenant administration guide for setup, RBAC, SaaS controls, and governance.",
    active: "Admin guide",
    icon: BookOpen,
    metrics: [
      {
        label: "Admin domains",
        value: "7",
        detail: "Tenants, users, roles, billing, branding, domains, imports",
      },
      {
        label: "Security model",
        value: "JWT + RBAC",
        detail: "Tenant-scoped access control",
      },
      {
        label: "Audit coverage",
        value: "Core",
        detail: "Tenant, auth, user, and role events",
      },
    ],
    sections: [
      {
  ...
  "training-videos": {
    ...
    description:
      "Structured enablement curriculum for onboarding admins and sales users.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Pipeline board workflow",
          "Site visit and reservation flow",
        ],
      },
      {
        title: "Manager track",
  ...
  "sales-deck": {
    ...
    title: "Sales deck",
    description:
      "Buyer-facing deck outline for selling BetFlow CRM to real estate teams.",
    active: "Sales deck",
    icon: Presentation,
    metrics: [
      {
        label: "Slides",
        value: "12",
        detail: "Problem, solution, proof, pricing, implementation",
      },
      {
        label: "Audience",
        value: "Executives",
        detail: "Developers and brokerages",
      },
      {
        label: "Close motion",
        value: "Demo-first",
        detail: "Seeded tenant walkthrough",
      },
    ],
    sections: [
      {
        ...
        items: [
          ...
          "Revenue leakage from manual approvals",
        ],
      },
      {
        title: "Product proof",
  ...
  "proposal-template": {
    ...
    description:
      "Reusable implementation proposal for tenant onboarding and SaaS subscription sale.",
    active: "Proposal",
    icon: FileSignature,
    metrics: [
      {
        label: "Sections",
        value: "10",
        detail: "Scope, timeline, pricing, assumptions, support",
      },
      {
        label: "Implementation",
        value: "30 days",
        detail: "Standard launch plan",
      },
      {
        label: "Commercial model",
        value: "SaaS + setup",
        detail: "Subscription, onboarding, optional migration",
      },
    ],
    sections: [
      {
  ...
  "support-process": {
    ...
    description:
      "Support intake, severity levels, escalation, and customer success operating model.",
    active: "Support",
    icon: LifeBuoy,
    metrics: [
      {
        label: "Channels",
        value: "4",
        detail: "Portal, email, WhatsApp, phone escalation",
      },
