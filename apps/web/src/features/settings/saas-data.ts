...
export const featureLimits: FeatureLimit[] = [
  { feature: "Users", used: 24, limit: 25, unit: "seats", reset: "Billing cycle" },
  { feature: "Active leads", used: 248, limit: 500, unit: "leads", reset: "Rolling" },
  { feature: "Storage", used: 82, limit: 250, unit: "GB", reset: "Never" },
  { feature: "Custom domains", used: 1, limit: 3, unit: "domains", reset: "Never" },
  { feature: "Monthly exports", used: 6, limit: 20, unit: "jobs", reset: "Jul 31, 2026" },
  { feature: "Excel import rows", used: 18400, limit: 50000, unit: "rows", reset: "Jul 31, 2026" },
  { feature: "Automation messages", used: 27420, limit: 50000, unit: "messages", reset: "Jul 31, 2026" },
];
...
export const brandingSettings: BrandingSetting[] = [
  ...
  { label: "Portal domain", value: "portal.betflowrealty.com", status: "Draft" },
...
export const customDomains: CustomDomain[] = [
  ...
  { domain: "portal.betflowrealty.com", status: "Pending DNS", ssl: "Pending", target: "portal.betflow.app" },
];
...
export const dataTransferJobs: DataTransferJob[] = [
  ...
  { id: "excel_001", type: "Excel import", scope: "Tower A unit inventory", requestedBy: "Lina Park", requestedAt: "Today, 10:25 AM", status: "Ready" },
...
export const onboardingSteps: OnboardingStep[] = [
  ...
  { step: "Configure roles and permissions", owner: "Tenant admin", status: "In progress", due: "Jul 2, 2026" },
  { step: "Publish branding and domain", owner: "Brand admin", status: "In progress", due: "Jul 3, 2026" },
  { step: "Import leads and inventory from Excel", owner: "Sales ops", status: "Not started", due: "Jul 5, 2026" },
