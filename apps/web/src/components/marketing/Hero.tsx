          ...
          <div className="lg:col-span-7 text-left space-y-6">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              ...
              <Link
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-indigo-500/40 bg-indigo-600/20 px-6 text-sm font-bold text-indigo-200 hover:bg-indigo-600/30 hover:text-white transition-all shadow-xs cursor-pointer"
              >
