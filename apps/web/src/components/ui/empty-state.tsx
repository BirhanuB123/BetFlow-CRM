...
export function EmptyState({
  ...
  return (
    <div className="flex min-h-[220px] w-full flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/40 p-8 text-center backdrop-blur-xs dark:border-slate-800 dark:bg-slate-900/40">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#233b66]/10 text-[#233b66] shadow-xs dark:bg-indigo-950/60 dark:text-indigo-400">
      ...
      <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
        {actionText && onAction && (
          <button
            type="button"
            onClick={onAction}
            className="inline-flex items-center gap-2 rounded-xl bg-[#233b66] px-4 py-2 text-xs font-medium text-white shadow-xs transition-all duration-150 hover:bg-[#1c3054] active:scale-[0.98]"
          >
