...
async function main() {
    ...
    const project = await prisma.project.upsert({
        ...
        update: {
            tenantId,
            name: 'Harbor Heights',
            description: 'Waterfront residential project with premium mixed-use inventory.',
            status: 'ACTIVE',
        },
        create: {
            id: 'project_001',
    ...
    const accounts = [
        {
            ...
            employees: 120,
            description: 'Mid-to-high rise residential developer active in Bole and CMC corridors.',
            ownerId: owner.id,
        },
        {
            id: 'account_002',
    ...
    for (const [id, firstName, lastName, company, email, phone, status, sourceId, ownerId,] of leads) {
    ...
    await prisma.notification.upsert({
        ...
        update: {
            ...
            message: 'Seeded sample CRM, inventory, sales, payments, documents, and audit data.',
            isRead: false,
        },
        create: {
            id: 'notification_001',
